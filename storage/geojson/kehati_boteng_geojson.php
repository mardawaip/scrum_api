...
FROM skp skp, kelurahan k, kecamatan c where skp.kategori = 'Kehati' AND skp.kelurahan_id = k.kelurahan_id AND k.kecamatan_id = c.kecamatan_id AND c.kecamatan_id =3";
