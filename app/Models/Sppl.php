...
{
    protected $table = 'sppl';
    protected $keyType = 'string';
    protected $status_perizinanType = 'string';
    protected $primaryKey = 'permohonan_id';
    protected $fillable = ['permohonan_id','member_id','pemohon_id','perusahaan_id','tgl_permohonan','jenisizin_id','nama_kegiatan','rencana_lokasi','no_reg','no_izin','tgl_terbit','keterangan','status_perizinan'];
